          ...
          <Card className="mb-8">
            ...
            <CardContent>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div>
                <h3 className="text-gray-900 font-semibold text-xl">ENSA Fes</h3>
                <p>
                  The conference will be held at ENSA Fes (École Nationale des Sciences Appliquées de Fès), 
                  a prestigious engineering school under Université Sidi Mohamed Ben Abdellah, known for its 
                  excellence in applied sciences and technology.
                  </p>
          ...
          <Card>
            ...
            <CardContent>
              <div className="aspect-video bg-gray-200 rounded-lg overflow-hidden">
                <iframe
                  src="https://maps.google.com/maps?q=33.9965042,-4.9918778&t=k&z=18&output=embed"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
